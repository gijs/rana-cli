...
def register(subparsers):
    ...
    p_v_list.add_argument("dataset_id")
    ...
    p_v_get.add_argument("dataset_id")
    ...
    p_v_create.add_argument("dataset_id")
    ...
    p_v_delete.add_argument("dataset_id")
