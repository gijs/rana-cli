...
def register(subparsers):
    ...
    p_get.add_argument("publication_id")
    ...
    p_update.add_argument("publication_id")
    ...
    p_delete.add_argument("publication_id")
    ...
    p_v_files.add_argument("publication_id")
    ...
    p_c_create.add_argument("publication_id")
    ...
    p_c_delete.add_argument("publication_id")
    p_c_delete.add_argument("comment_id")
    p_c_delete.set_defaults(func=cmd_comments_delete)

    p_c_msg = comments_sub.add_parser("add-message", help="add a message to an existing comment thread")
    add_env_tenant_args(p_c_msg)
    p_c_msg.add_argument("publication_id")
    ...
    p_c_resolve.add_argument("publication_id")
    ...
    p_c_unresolve.add_argument("publication_id")
...
def cmd_versions_create(args):
    client = get_client(args)
    emit(client.post(f"/tenants/{{tenant_id}}/publications/{args.publication_id}/versions"))
...
def cmd_comments_list(args):
    client = get_client(args)
    emit(client.get(f"/tenants/{{tenant_id}}/publications/{args.publication_id}/comments"))
